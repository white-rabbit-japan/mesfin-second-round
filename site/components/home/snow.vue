...
import snow from '~/assets/img/home/snow.svg?url'
import sakura from '~/assets/img/home/sakura.svg?url'

const FLAKES = 45
const isSakuraSeason = computed(() => {
  //between March 20 & April 10th
...
<template>
  <div class="snowfall">
    <div class="snowflake" v-for="index in FLAKES">
      <img :src="isSakuraSeason ? sakura : snow" />️
    </div>
  </div>
</template>
